...
export type Escrow = {
  ...
  mintMaker: Address;
  mintTaker: Address;
  mintMakerTokenProgram: Address;
  mintTakerTokenProgram: Address;
  makerOffer: bigint;
  makerAsk: bigint;
  bump: number;
};
...
export function getEscrowEncoder(): FixedSizeEncoder<EscrowArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ['mintMaker', getAddressEncoder()],
      ['mintTaker', getAddressEncoder()],
      ['mintMakerTokenProgram', getAddressEncoder()],
      ['mintTakerTokenProgram', getAddressEncoder()],
...
export function getEscrowDecoder(): FixedSizeDecoder<Escrow> {
  return getStructDecoder([
    ...
    ['mintMaker', getAddressDecoder()],
    ['mintTaker', getAddressDecoder()],
    ['mintMakerTokenProgram', getAddressDecoder()],
    ['mintTakerTokenProgram', getAddressDecoder()],
